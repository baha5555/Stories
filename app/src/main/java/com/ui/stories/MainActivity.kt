...
@Composable
fun Greeting() {
    val listOfImages = listOf(R.drawable.zoo_one, R.drawable.zoo_two, R.drawable.zoo_three,R.drawable.zoo_one, R.drawable.zoo_two, R.drawable.zoo_three,R.drawable.zoo_one, R.drawable.zoo_two, R.drawable.zoo_three)
